...
import { ImportEvidenceState, AnalysisScopeNote } from "./CoverageStatus";
import { EXPORT_JOB_BUSY_HINT, EXPORT_NEEDS_ANALYSIS_HINT } from "./Sidebar";
import { coverageCanExport } from "../lib/analysisCoverage";
import { isPartialEvidenceAnalysis } from "../lib/analysisScope";
      ...
      <div className="min-h-0 flex-1 overflow-auto p-3">
          <div className="grid w-full gap-4">
            ...
            <section className="space-y-2">
              {isPartialEvidenceAnalysis(coverage) ? (
                <AnalysisScopeNote>
                  This report includes only results from the analysis that already ran. Sections
                  that were not analyzed will be empty.
                </AnalysisScopeNote>
              ) : null}
